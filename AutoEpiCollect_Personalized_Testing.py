...
if not case1:
    final_genes = sorted_gene_mutations_series.loc[sorted_gene_mutations_series.index.isin(additional20)]
    gene_mutations = final_genes.to_dict()
    print(gene_mutations)
else:
    topx_genes = sorted_gene_mutations_series.head(50)
    gene_mutations = {}
    for g in topx_genes.index:
