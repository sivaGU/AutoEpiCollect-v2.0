...
def calculate(epitope=None, allele=None, population=None, mhc_class=None, user_defined_population=None):
    ...
    result = pc.calculate_coverage(population=population, mhc_class=mhc_class, filename=tmpfile.name, user_defined_population_data_lines=user_defined_population)
